   ...
   window.ResizeObserver = mockResizeObserver;
    ...
    it("should display the JSON content of a single resource", async () => {
      await act(async () =>{ render(
        <RouterContext.Provider value ={createMockRouter({query: {resource: 'DiagnosticReport', id: 'denom-EXM125-3'}})}>

            <ResourceIDPage></ResourceIDPage>
      ...
      spanElems.forEach(el => {spanText.push(el.textContent || '')})
      ...
      expect(spanText.includes('"http://hl7.org/fhir/us/core/StructureDefinition/us-core-diagnosticreport-note"')).toBe(true)
  }); 
